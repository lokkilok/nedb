...
This is a fork of the original [nedb](https://github.com/louischatriot/nedb) database with small updates to address vulnerabilities.
...
## Installation, tests
Module name on npm and bower is `nedb-2`.

```
npm install nedb-2 --save    # Put latest version in your package.json
npm test                     # You'll need the dev dependencies to launch tests
bower install nedb-2         # For the browser versions, which will be in browser-version/out
```
