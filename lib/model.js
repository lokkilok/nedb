...
/**
 * Check that a field won't pollute prototypes.
 * 
 * See https://security.snyk.io/vuln/SNYK-JS-NEDB-1305279
 */
function checkField(field) {
  const forbidden = ['__proto__', 'prototype', 'constructor']
  if (forbidden.includes(field)) {
    throw Error(`Modifying the ${field} is not allowed!`)
  }
}
